...
exports.pashtoReplacerRegex = /اً|ا|آ|ٱ|ٲ|ٳ|ی|ي|ې|ۍ|ئ|ے|س|ص|ث|څ|ج|چ|ه|ۀ|ہ|ع|و|ؤ|ښ|غ|خ|ح|ش|ز|ض|ذ|ځ|ظ|ژ|ر|ړ|ڑ|ت|ټ|ٹ|ط|د|ډ|ڈ|نب|ن|ڼ|ک|ګ|گ|ق|ږ|ب|پ|ف/g;
var aaySoundLatin = "h?(?:[aá]a?i|[eé]y|[aá]a?y|[aá]h?i)";
var longASoundLatin = "(?:[aá]a?)h?";
var shortASoundLatin = "h?(?:[aáă]a?|au|áu|[uú]|[UÚ]|[ií]|[eé])?h?";
var shwaSoundLatin = "h?(?:[uú]|[oó]o?|w[uú]|[aáă]|[ií]|[UÚ])?h?";
var ooSoundLatin = "h?(?:[oó]o?|[áa]u|w[uú]|[aá]w|[uú]|[UÚ])(?:h|w)?";
var eySoundLatin = "h?(?:[eé]y|[eé]e?|[uú]y|[aá]y|[ií])";
var middleESoundLatin = "h?(?:[eé]e?|[ií]|[aáă]|[eé])(?:h|y)?";
var iSoundLatin = "h?(?:[uú]|[aáă]|[ií]|[eé]e?)?h?";
exports.latinReplacerInfo = [
...
// tslint:disable-next-line
exports.latinReplacerRegex = /aa|áa|a{1,2}[i|y]|á{1,2}[i|y]|a|á|U|Ú|u|ú|o{1,2}|óo|ó|e{1,2}|ée|é|ey|éy|uy|úy|i|í|w|y|q|g|ts|sh|s|dz|z|tt|t|T|dd|d|D|r{1,2}|R|n{1,2}|N|f{1,2}|f|b{1,2}|p{1,2}|x|kh|q|k|gh|g|G|j|ch|ll|l|m{1,2}|h/g;
